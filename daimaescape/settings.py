...
# ALLOWED_HOSTS – Railway automatically sets RAILWAY_PUBLIC_DOMAIN.
# You can also add custom domains via the ALLOWED_HOSTS environment variable.
...
# Database – Railway automatically injects DATABASE_URL when you add Postgres
DATABASES = {
...
# Logging – console only for production (Railway captures stdout)
LOGGING = {
    'version': 1,
